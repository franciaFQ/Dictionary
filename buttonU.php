        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
                    ...
                    <h5><center>Type: <strong><?php echo $nameT; ?></strong></center></h5> 
                </div> 
				</div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-info" data-dismiss="modal"> Cancel</button>
                    <a href="actions.php?acc=delU&id=<?php echo $code ?>" class="btn btn-danger"> Delete</a>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
					...
					<div class="container-fluid">
						<form method="POST" action="actions.php?acc=editU">
							<div class="row">
								<div class="col-lg-2">
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <label style="position:relative; top:7px;" for="passE">Password:</label>
                                </div>
                                <div class="col-lg-10">
                                    <input type="text" name="passE" class="form-control" value="<?php echo $pass; ?>">
                                </div>
                            </div>
	                </div>
				</div>
